...
.setCustomId('form')
.setTitle('Rrfanx - Destek Sistemi!')
...
const embed = new EmbedBuilder()
.setTitle("Rrfanx - Kullanıcı Paneli!")
...
.setCustomId('form13')
.setTitle('Rrfanx - Menülü Rol Alma Sistemi!')
...
value: "s2"
    ...
    const embed = new EmbedBuilder()
    .setTitle("Rrfanx - Rol Alma Sistemi!")
...
client.on("interactionCreate", async (interaction, message) => {
  ...
  if(interaction.customId === "yardım") {
    ...
    let message = interaction.message.id
      ...
      .setTitle("Rrfanx - Moderasyon Sistemi!")
    ...
    if (interaction.values[0] == "kullanıcı") { 
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("Rrfanx - Kullanıcı Sistemi!")
  ...
  .setColor("#ff0000")
    ...
    if (interaction.values[0] == "giveaway") {
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("Rrfanx - Çekiliş Sistemi!")
...
.setCustomId('formaq')
.setTitle('Rrfanx - Başvuru Formu!')
const a15 = new TextInputBuilder()
.setCustomId('isim')
.setLabel('İsminiz?')
.setStyle(TextInputStyle.Paragraph) 
.setMinLength(2)
.setPlaceholder('irfan')
.setRequired(true)
...
client.on('ready', () => {
 joinVoiceChannel({
  channelId: "1016445230083473488",
  guildId: "1005751810348290080",
  adapterCreator: client.guilds.cache.get("1005751810348290080").voiceAdapterCreator
})
})